...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOH, GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_8|GPIO_PIN_14);

    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_11|GPIO_PIN_12);
